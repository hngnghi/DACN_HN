...
namespace QUANLYSINHVIEN.Controllers
{
    public class LopsController : Controller
    {
        ...
        public LopsController(WquanlysinhvienContext context)
        {
            _context = context;
        }
        ...
        {
            var wquanlysinhvienContext = _context.Lops.Include(l => l.MaKhoaNavigation);
        ...
        public async Task<IActionResult> Create([Bind("MaLop,TenLop,MaKhoa,KhoaHoc")] Lop lop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaLop,TenLop,MaKhoa,KhoaHoc")] Lop lop)
        {
            if (id != lop.MaLop)
            {
                return NotFound();
